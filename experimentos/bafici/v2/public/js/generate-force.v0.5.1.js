...
// agrega las estadísticas al grafo
...
var radioAcumulado = 0;
var supCirculos = 0;

function statistics (nodos,radio,sCan, sCir){
	var limiteNodos = 200;
	var limitePorcentaje = 30;
	
	
	// este condicional se revisa en la version 0.5.2
	if ( limitePorcentaje < ( sCir * 100 / sCan ) && limiteNodos < nodos ){
		var cond = "pop nodo";
	}else{
		var cond = "";
	}
